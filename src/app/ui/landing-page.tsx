  ...
  return isLoading || banksQ?.isLoading ? (
    ...
    <div className="min-h-screen bg-linear-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950">
      ...
      <header className="sticky top-0 z-40 w-full border-b bg-white/80 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-950/80">
        <div className="flex h-16 items-center justify-between px-4 md:px-6 w-full">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">{outreach?.theme}</span>
          </Link>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-primary/10 to-purple-500/10 dark:from-primary/5 dark:to-purple-500/5" />
        <div className="container px-4 md:px-6 relative">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div data-aos="fade-right">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:items-center">
                <Button
                  ...
                  className={clsx(
                    "font-medium",
                    outreach?.isActive ? "" : "bg-gray-500",
                  )}
                  onClick={() => setRegisterDialog(true)}
                  disabled={!outreach?.isActive}>
                  Register Now
              ...
              <Button
                className={clsx(
                  "mt-4 md:flex",
                  outreach?.isActive ? "hover:bg-green-500" : "bg-gray-600",
                )}
              ...
              {!outreach?.isActive && (
                <p className="flex flex-row items-center gap-2 my-4">
                  <AlertOctagon className="w-5 text-red-600" />
            ...
            <div
              ...
              data-aos="fade-left"
              data-aos-delay="200">
              <div className="absolute -inset-4 rounded-xl bg-linear-to-r from-primary/20 to-purple-500/20 blur-xl" />
              {outreach?.flyer ? (
                <CldImage
                  width="600"
                  height="750"
      ...
      <footer className="border-t bg-white dark:bg-gray-950 dark:border-gray-800 mt-[8%]">
        <div className="container px-4 md:px-6 py-12">
          ...
          <div className="mt-12 pt-8 text-center text-gray-50">
            <p>
              &copy; {new Date().getFullYear()} {outreach?.theme}. All rights
              reserved.
            </p>
          </div>
        </div>
          ...
          <Tooltip>
            ...
            <TooltipTrigger>
              <Button
                ...
                size={"icon"}
                variant={"outline"}
                className="bg-white dark:bg-gray-950 min-w-[60px] min-h-[60px] rounded-full shadow-md">
                <a href="https://wa.link/hvvlu9" target="_blank">
                  <SiWhatsapp
                    title="Contact us via WhatsApp"
                    className="text-green-500 size-7"
                  />
                </a>
              </Button>
            </TooltipTrigger>
